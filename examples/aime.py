...
def parse_args() -> argparse.Namespace:
    ...
    # dataset
    p.add_argument("--test-repeat", type=int, default=5, help="Repeat the AIME 2025 test set N times to reduce variance")
    p.add_argument("--data-seed", type=int, default=0)

    # models
    p.add_argument("--task-model", default="openai:gpt-5-mini")
    p.add_argument("--task-effort", default="minimal", choices=["minimal", "low", "medium", "high"], help="Reasoning effort (ignored for non-reasoning models)")
